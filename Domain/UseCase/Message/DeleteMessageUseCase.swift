...
public final class DeleteMessageUseCase: UseCase<Message, Never> {
    ...
    override func buildObservable(params: Message) -> Observable<Never> {
        return messageRepository.delete(message: params).asObservable()
    }
